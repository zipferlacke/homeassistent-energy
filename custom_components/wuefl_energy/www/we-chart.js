 ...
 * diagramm_v1.2.0 und ist Zeichen für Zeichen dasselbe wie in der Bibliothek.
 *
...
import { Diagramm, setIcons } from './diagramm_v1.2.0/diagramm_v1_2_0.js';
...
function diagrammCss() {
  if (!cssPromise) {
    cssPromise = fetch(new URL('./diagramm_v1.2.0/diagramm_v1_2_0.css', import.meta.url))
      .then((r) => (r.ok ? r.text() : ''))
      .catch(() => '');
  }
  return cssPromise;
